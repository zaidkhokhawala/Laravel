        ...
        <div class="banner-contain">
            <div class="media background-biolife-banner__promotion">
                <div class="img-moving position-1">
                    <img src="{{ asset('website/assets/images/home-03/img-moving-pst-1.png') }}" width="149" height="139" alt="img msv">
                </div>
                <div class="img-moving position-2">
                    <img src="{{ asset('website/assets/images/home-03/img-moving-pst-2.png') }}" width="185" height="265" alt="img msv">
                </div>
                <div class="img-moving position-3">
                    <img src="{{ asset('website/assets/images/home-03/img-moving-pst-3-cut.png') }}" width="384" height="151" alt="img msv">
                </div>
                <div class="img-moving position-4">
                    <img src="{{ asset('website/assets/images/home-03/img-moving-pst-4.png') }}" width="198" height="269" alt="img msv">
                </div>
            </div>
