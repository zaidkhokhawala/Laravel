...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('website/assets/css/nice-select.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('website/assets/css/slick.min.css') }}">
...
<body class="biolife-body">
    ...
    <header id="header" class="header-area style-01 layout-03">
        <div class="header-top bg-main hidden-xs" style="background-color: orangered;">
            <div class="container">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-md-2 col-md-6 col-xs-6">
                        <a href="index" class="biolife-logo"><img src="{{ asset('website/assets/images/organic-3.png') }}" alt="biolife logo" width="135" height="34"></a>
                    </div>
                        ...
                        <div class="primary-menu">
                            <ul class="menu biolife-menu clone-main-menu clone-primary-menu" id="primary-menu" data-menuname="main menu">
                                ...
                                <li class="menu-item menu-item-has-children has-megamenu">
                                    <a href="product_list" class="menu-name" data-title="Shop">Shop</a>

                             <!-- 2 no start -->        <div class="wrap-megamenu lg-width-900 md-width-750">
                                        <div class="mega-content row justify-content-between">
                                            <!-- Fresh Fruits (Wider) -->
                                            <div class="col-lg-3 col-md-4 col-xs-12 md-margin-bottom-0 xs-margin-bottom-25">
                                                <div class="wrap-custom-menu vertical-menu">
                                                    <h4 class="menu-title">🍎 Fresh Fruits</h4>
                                                    <ul class="menu">
                                                        <li><a href="#">🍏 Apples (Red, Green, Fuji)</a></li>
                                                        <li><a href="#">🍌 Bananas & Plantains</a></li>
                                                        <li><a href="#">🍊 Oranges & Citrus Fruits</a></li>
                                                        <li><a href="#">🍇 Grapes (Red, Green, Black)</a></li>
                                                        <li><a href="#">🍍 Pineapple & Coconut</a></li>
                                                    </ul>
                                                </div>
                                            </div>

                                            <!-- Fresh Berries -->
                                            <div class="col-lg-2 col-md-3 col-xs-12 md-margin-bottom-0 xs-margin-bottom-25">
                                                <div class="wrap-custom-menu vertical-menu">
                                                    ...
                                                    <ul class="menu">
                                                        ...
                                                        <li><a href="#">🫑 Mulberries</a></li>
                                                    </ul>
                                                </div>
                                            </div>

                                            <!-- Fresh Vegetables (Wider) -->
                                            <div class="col-lg-3 col-md-4 col-xs-12 md-margin-bottom-0 xs-margin-bottom-25">
                                                <div class="wrap-custom-menu vertical-menu">
                                                    <h4 class="menu-title">🥦 Fresh Vegetables</h4>
                                                    <ul class="menu">
                                                        <li><a href="#">🥬 Leafy Greens (Spinach, Kale, Lettuce)</a></li>
                                                        <li><a href="#">🥕 Root Vegetables (Carrots, Potatoes, Beets)</a></li>
                                                        <li><a href="#">🌶️ Peppers (Bell Peppers, Chili Peppers)</a></li>
                                                        <li><a href="#">🍅 Tomatoes & Cucumbers</a></li>
                                                        <li><a href="#">🧅 Mushrooms & Onions</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-2 col-md-3 col-xs-12 md-margin-bottom-0 xs-margin-bottom-25">
                                                <div class="wrap-custom-menu vertical-menu">
                                                    <h4 class="menu-title">🌿 Organic & Exotic</h4>
                                                    <ul class="menu">
                                ...
                                <li class="menu-item menu-item-has-children has-child">
                                    <a href="#" class="menu-name" data-title="Deals">Deals</a>
                                    <ul class="sub-menu">
                                        <li class="menu-item"><a href="#">Ongoing Discounts</a></li>
                                        <li class="menu-item"><a href="#">Buy 1 Get 1 Free</a></li>
                                        <li class="menu-item menu-item-has-children has-child">
                                            <a href="#" class="menu-name" data-title="Limited-Time Offers">Limited-Time Offers</a>
                                            <ul class="sub-menu">
                                                <li class="menu-item"><a href="#">Flash Sale</a></li>
                                                <li class="menu-item"><a href="#">Seasonal Discounts</a></li>
                                                <li class="menu-item"><a href="#">Exclusive Member Deals</a></li>
                                                <li class="menu-item"><a href="#">Festive Offers</a></li>
                                            </ul>
                                        </li>
                                        <li class="menu-item"><a href="#">New Customer Offers</a></li>
                                        <li class="menu-item"><a href="#">Subscription Discounts</a></li>
                                    </ul>
                                </li>
                                            ...
                                            <ul class="products">
                                                <li>
                                                    <div class="minicart-item">
                                                        <div class="thumb">
                                                            <a href="#"><img src="{{ asset('website/assets/images/minicart/pr-01.jpg') }}" width="90" height="90" alt="National Fresh"></a>
                                                        </div>
                                                        <div class="left-info">
                                                ...
                                                <li>
                                                    <div class="minicart-item">
                                                        <div class="thumb">
                                                            <a href="#"><img src="{{ asset('website/assets/images/minicart/pr-02.jpg') }}" width="90" height="90" alt="National Fresh"></a>
                                                        </div>
                                                        <div class="left-info">
                                                            <div class="product-title"><a href="#" class="product-name">National Fresh Fruit</a></div>
                                                            <div class="price">
                                                ...
                                                <li>
                                                    <div class="minicart-item">
                                                        <div class="thumb">
                                                            <a href="#"><img src="{{ asset('website/assets/images/minicart/pr-03.jpg') }}" width="90" height="90" alt="National Fresh"></a>
                                                        </div>
                                                        <div class="left-info">
                                                            <div class="product-title"><a href="#" class="product-name">National Fresh Fruit</a></div>
                                                            <div class="price">
                                                ...
                                                <li>
                                                    <div class="minicart-item">
                                                        <div class="thumb">
                                                            <a href="#"><img src="{{ asset('website/assets/images/minicart/pr-04.jpg') }}" width="90" height="90" alt="National Fresh"></a>
                                                        </div>
                                                        <div class="left-info">
                                                            <div class="product-title"><a href="#" class="product-name">National Fresh Fruit</a></div>
                                                            <div class="price">
                                                ...
                                                <li>
                                                    <div class="minicart-item">
                                                        <div class="thumb">
                                                            <a href="#"><img src="{{ asset('website/assets/images/minicart/pr-05.jpg') }}" width="90" height="90" alt="National Fresh"></a>
                                                        </div>
                                                        <div class="left-info">
                                                            <div class="product-title"><a href="#" class="product-name">National Fresh Fruit</a></div>
                                                            <div class="price">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-md-4">
                        <div class="vertical-menu vertical-category-block" style="background-color: orangered;">
                                                            ...
                                                            <ul class="products-list default-product-style biolife-carousel nav-none-after-1k2 nav-center" data-slick='{"rows":1,"arrows":true,"dots":false,"infinite":false,"speed":400,"slidesMargin":30,"slidesToShow":1, "responsive":[{"breakpoint":767, "settings":{ "arrows": false}}]}'>
                                                                    ...
                                                                    <div class="contain-product none-overlay">
                                                                        <div class="product-thumb">
                                                                            <a href="#" class="link-to-product">
                                                                                <img src="{{ asset('website/assets/images/products/p-08.jpg') }}" alt="dd" width="270" height="270" class="product-thumnail">
                                                                            </a>
                                                                        </div>
                                                                        <div class="info">
                                                                ...
                                                                <li class="product-item">
                                                                    <div class="contain-product none-overlay">
                                                                        <div class="product-thumb">
                                                                            <a href="#" class="link-to-product">
                                                                                <img src="{{ asset('website/assets/images/products/p-11.jpg') }}" alt="dd" width="270" height="270" class="product-thumnail">
                                                                            </a>
                                                                        </div>
                                                                        <div class="info">
                                                                            <b class="categories">Fresh Fruit</b>
                                                                ...
                                                                <li class="product-item">
                                                                    <div class="contain-product none-overlay">
                                                                        <div class="product-thumb">
                                                                            <a href="#" class="link-to-product">
                                                                                <img src="{{ asset('website/assets/images/products/p-15.jpg') }}" alt="dd" width="270" height="270" class="product-thumnail">
                                                                            </a>
                                                                        </div>
                                                                        <div class="info">
                                                                            <b class="categories">Fresh Fruit</b>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12 col-md-12 col-sm-12 md-margin-top-9">
                                                        <div class="biolife-brand">
                                                            <ul class="brands">
                                                                <li><a href="#"><img src="{{ asset('website/assets/images/megamenu/brand-organic.png') }}" width="161" height="136" alt="organic"></a></li>
                                                                <li><a href="#"><img src="{{ asset('website/assets/images/megamenu/brand-explore.png') }}" width="160" height="136" alt="explore"></a></li>
                                                                <li><a href="#"><img src="{{ asset('website/assets/images/megamenu/brand-organic-2.png') }}" width="99" height="136" alt="organic 2"></a></li>
                                                                <li><a href="#"><img src="{{ asset('website/assets/images/megamenu/brand-eco-teas.png') }}" width="164" height="136" alt="eco teas"></a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-5 col-md-4 col-sm-12 lg-padding-left-57 md-margin-bottom-30">
                                                        <div class="biolife-brand vertical md-boder-left-30">
                                                            ...
                                                            <ul class="brands">
                                                                <li><a href="#"><img src="{{ asset('website/assets/images/megamenu/v-brand-organic.png') }}" width="167" height="74" alt="organic"></a></li>
                                                                <li><a href="#"><img src="{{ asset('website/assets/images/megamenu/v-brand-explore.png') }}" width="167" height="72" alt="explore"></a></li>
                                                                <li><a href="#"><img src="{{ asset('website/assets/images/megamenu/v-brand-organic-2.png') }}" width="167" height="99" alt="organic 2"></a></li>
                                                                <li><a href="#"><img src="{{ asset('website/assets/images/megamenu/v-brand-eco-teas.png') }}" width="167" height="67" alt="eco teas"></a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </div>
